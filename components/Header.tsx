...
export default function Header() {
  ...
  const getMobileNavLinkClass = ({ isActive }: { isActive: boolean }) =>
    `block text-gray-300 hover:text-white px-3 py-2 rounded-md text-base font-medium transition-colors ${
      isActive ? 'text-white bg-gray-900' : ''
    }`;

  const navLinks = [
    { to: '/events', label: 'Events' },
    { to: '/people', label: 'Our Board' },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-900 focus:outline-none transition-colors"
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4">
            ...
            {/* Mobile Social Icons */}
            <div className="flex items-center space-x-4 px-3 py-4 border-t border-gray-900">
              <a
                href="https://www.youtube.com/@DSMLIUI/videos"
                target="_blank"
                rel="noopener noreferrer"
